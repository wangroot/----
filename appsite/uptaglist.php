...
$tagname=$_POST['tagname'];
  ...
  $rs=mysql_query("select count(*) from site where sTag LIKE '%{$tagname}%' ",$conn); //取得记录总数$rs
...
{
	$sites =array(); 
	$mysite=new site(0,"last","last","last","last",0,"last",0,0);	       
...
$sitesql="select * from site where sTag LIKE '%{$tagname}%' limit 0,$offset"; 
